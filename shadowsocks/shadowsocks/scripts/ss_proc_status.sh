...
echo_version(){
	echo ① 程序版本（插件版本：3.6.3）：
	echo -----------------------------------------------------------
	echo "程序			版本		备注"
	echo "ss-redir		3.1.0		2017年10月22日"
	echo "ss-tunnel		3.1.0 		2017年10月22日"
	echo "ss-local		3.1.0		2017年10月22日"
	echo "obfs-local		0.0.3		2017年10月21日"
	echo "ssr-redir		2.5.6 		with mbed TLS 2.6.0"
	echo "ssr-tunnel		2.5.6 		with mbed TLS 2.6.0"
	echo "ssr-local		2.5.6 		with mbed TLS 2.6.0"
